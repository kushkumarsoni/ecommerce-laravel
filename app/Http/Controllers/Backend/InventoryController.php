...
use App\Models\{Product,Language};
...
class InventoryController extends Controller
{
    ...
    //Manage Stock page load
     public function getManageStockPageLoad() {
        ...
        return view($this->theme.'.manage-stock', compact('AllCount', 'InStockCount', 'OutOfStockCount', 'languageslist', 'datalist'));		
	}
	...
	public function getManageStockTableData(Request $request){
		...
		if($request->ajax()){
			...
			return view($this->theme.'.partials.manage_stock_table', compact('datalist'))->render();
		}
	}
