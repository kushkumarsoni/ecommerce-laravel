...
function PageVariation(){
	...
	$data = array();
	$results = SystemSetting::where('type', 'page_variation')->get();
...
function CategoryMenuList(){
	...
	$datalist = ProductCategory::where('lan', '=', $lan)->where('is_publish', '=', 1)->orderBy('id', 'ASC')->get();
	$li_List = '';
...
function CategoryListForMobile(){
	...
	$datalist = ProductCategory::where('lan', '=', $lan)->where('is_publish', '=', 1)->orderBy('name','ASC')->get();
	$li_List = '';
	foreach($datalist as $row){
		$id = $row->id;
		$slug = $row->slug;
...
function gtext(){
	...
	//general_settings
	$general_settings = SystemSetting::where('type', 'general_settings')->get();
	...
	if($general_settings_id != ''){
		...
		$general_settingsDataObj = json_decode($general_settingsData[0]->value);
	...
	//theme_logo
	$theme_logo = SystemSetting::where('type', 'theme_logo')->get();
	...
	if($theme_logo_id != ''){
		...
		$theme_logoObj = json_decode($theme_logoData[0]->value);
	...
	//currency
 	$currency = SystemSetting::where('type', 'currency')->get();
	...
	if($currency_id != ''){
		...
		$currencyObj = json_decode($currencyData[0]->value);
	...
	//theme_option_header
 	$theme_option_header = SystemSetting::where('type', 'theme_option_header')->get();
	...
	if($theme_option_header_id != ''){
		...
		$theme_option_headerObj = json_decode($theme_option_headerData[0]->value);
	...
	//Language Switcher
	$language_switcher_data = SystemSetting::where('type', 'language_switcher')->get();
	...
	if($language_switcher_id != ''){
		...
		$wsObj = json_decode($wsData[0]->value);
	...
	//theme_option_footer
 	$theme_option_footer = SystemSetting::where('type', 'theme_option_footer')->get();
	...
	if($theme_option_footer_id != ''){
		...
		$theme_option_footerObj = json_decode($theme_option_footerData[0]->value);
	...
	//facebook
 	$facebook = SystemSetting::where('type', 'facebook')->get();
	...
	if($facebook_id != ''){
		...
		$facebookObj = json_decode($facebookData[0]->value);
	...
	//twitter
 	$twitter = SystemSetting::where('type', 'twitter')->get();
	...
	if($twitter_id != ''){
		...
		$twitterObj = json_decode($twitterData[0]->value);
	...
	//Theme Option SEO
 	$theme_option_seo = SystemSetting::where('type', 'theme_option_seo')->get();
	...
	if($theme_option_seo_id != ''){
		...
		$SEOObj = json_decode($SEOData[0]->value);
	...
	//Theme Option Facebook Pixel
 	$theme_option_facebook_pixel = SystemSetting::where('type', 'facebook-pixel')->get();
	...
	if($theme_option_fb_pixel_id != ''){
		...
		$fb_PixelObj = json_decode($fb_PixelData[0]->value);
	...
	//Theme Option Google Analytics
 	$theme_option_google_analytics = SystemSetting::where('type', 'google_analytics')->get();
	...
	if($theme_option_ga_id != ''){
		...
		$gaObj = json_decode($gaData[0]->value);
	...
	//Theme Option Google Tag Manager
 	$theme_option_google_tag_manager = SystemSetting::where('type', 'google_tag_manager')->get();
	...
	if($theme_option_gtm_id != ''){
		...
		$gtmObj = json_decode($gtmData[0]->value);
	...
	//Google Recaptcha
 	$theme_option_google_recaptcha = SystemSetting::where('type', 'google_recaptcha')->get();
	...
	if($google_recaptcha_id != ''){
		...
		$grObj = json_decode($grData[0]->value);
	...
	//Google Map
 	$theme_option_google_map = SystemSetting::where('type', 'google_map')->get();
	...
	if($google_map_id != ''){
		...
		$gmObj = json_decode($gmData[0]->value);
	...
	//Theme Color
 	$theme_color = SystemSetting::where('type', 'theme_color')->get();
	...
	if($theme_color_id != ''){
		...
		$tcObj = json_decode($tcData[0]->value);
	...
	//Mail Settings
 	$theme_option_mail_settings = SystemSetting::where('type', 'mail_settings')->get();
	...
	if($mail_settings_id != ''){
		...
		$msObj = json_decode($msData[0]->value);
	...
	//Bank Transfer
	$bank_data = SystemSetting::where('type', 'bank_transfer')->get();
	...
	if($bank_id != ''){
		...
		$btObj = json_decode($btData[0]->value);
	...
	//MailChimp
	$mailchimp_data = SystemSetting::where('type', 'mailchimp')->get();
	...
	if($mailchimp_id != ''){
		...
		$mcObj = json_decode($mcData[0]->value);
	...
	//Subscribe Popup
	$subscribe_popup_data = SystemSetting::where('type', 'subscribe_popup')->get();
	...
	if($subscribe_id != ''){
		...
		$spObj = json_decode($spData[0]->value);
	...
	//Whatsapp
	$whatsapp_data = SystemSetting::where('type', 'whatsapp')->get();
	...
	//custom_css
	$custom_css_data = SystemSetting::where('type', 'custom_css')->get();
	$custom_css = '';
	foreach ($custom_css_data as $row){
		$custom_css = $row->value;
	}
	$data['custom_css'] = $custom_css;

	//custom_js
	$custom_js_data = SystemSetting::where('type', 'custom_js')->get();
	$custom_js = '';
...
function vipc(){
	...
	$datalist = SystemSetting::where('type', 'vipc')->get();
...
function OrderCount($status_id) {
	if($status_id == 0){
		$count = OrderMaster::count();
	}else{
		$count = OrderMaster::where('order_status_id', '=', $status_id)->count();
	}
...
function OrderCountForSeller($status_id) {
	...
	if($status_id == 0){
		$count = OrderMaster::where('seller_id', '=', $seller_id)->count();
	}else{
		$count = OrderMaster::where('order_status_id', '=', $status_id)->where('seller_id', '=', $seller_id)->count();
	}
...
function gSellerSettings(){
	...
	$datalist = SystemSetting::where('type', 'seller_settings')->get();
	$id = '';
	$value = '';
	foreach ($datalist as $row){
		$id = $row->id;
	...
	$data = array();
	if($id != ''){
		$data['fee_withdrawal'] = $value->fee_withdrawal;
		$data['product_auto_publish'] = $value->product_auto_publish;
		$data['seller_auto_active'] = $value->seller_auto_active;
	}else{
