...
function onPaginationDataLoad(page) {
	$.ajax({
		url:base_url + "/admin/getMenuTableData?page="+page,
...
function onRefreshMenuData() {
	$.ajax({
		url:base_url + "/admin/getMenuTableData",
		success:function(data){
			$('#menu_datalist').html(data);
			onCheckAll();
		}
...
function onMenuSearch() {
	...
	$.ajax({
		url: base_url + "/admin/getMenuTableData?search="+search,
		success:function(data){
			$('#menu_datalist').html(data);
			onCheckAll();
		}
...
function onConfirmWhenAddEdit() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/saveMenuData',
...
function onConfirmBulkAction() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/bulkActionMenu',
