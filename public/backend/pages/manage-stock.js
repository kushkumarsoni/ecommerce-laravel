...
function onPaginationDataLoad(page) {
	...
	$.ajax({
		url:base_url + "/admin/getManageStockTableData?page="+page
...
function onRefreshData() {
	...
	$.ajax({
		url:base_url + "/admin/getManageStockTableData?status="+$("#view_by_status").val()
		+"&search="+$("#search").val()
		+"&language_code="+$('#language_code').val(),
		success:function(data){
			$('#tp_datalist').html(data);
...
function onSearch() {
	...
	$.ajax({
		url: base_url + "/admin/getManageStockTableData?search="+$("#search").val()
		+"&status="+$("#view_by_status").val()
		+"&language_code="+$('#language_code').val(),
		success:function(data){
			$('#tp_datalist').html(data);
...
function onConfirmWhenAddEdit() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/saveManageStockData',
