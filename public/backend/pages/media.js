...
function onPaginationDataLoad(page) {
	$.ajax({
		url: base_url +"/admin/getMediaPaginationData?page="+page,
...
function onMediaPaginationDataLoad() {
	$.ajax({
		url: base_url + "/admin/getMediaPaginationData",
		success:function(data){
			$('#media_datalist').html(data);
		}
	});
...
function onMediaSearch() {
	...
	$.ajax({
		url: base_url + "/admin/getMediaPaginationData?search="+search,
		success:function(data){
			$('#media_datalist').html(data);
		}
	});
...
function onConfirmWhenAddEdit() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/mediaUpdate',
