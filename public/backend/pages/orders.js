...
function onPaginationDataLoad(page) {
	...
	$.ajax({
		url:base_url + "/admin/getOrdersTableData?page="+page+"&status="+status+"&start_date="+start_date+"&end_date="+end_date,
...
function onRefreshData() {
	...
	$.ajax({
		url:base_url + "/admin/getOrdersTableData?status="+status,
		success:function(data){
			$('#tp_datalist').html(data);
			onCheckAll();
		}
...
function onSearch() {
	...
	$.ajax({
		url: base_url + "/admin/getOrdersTableData?search="+search+"&status="+status,
		success:function(data){
			$('#tp_datalist').html(data);
			onCheckAll();
		}
...
function onFilterAction() {
	...
	$.ajax({
		url: base_url + "/admin/getOrdersTableData?start_date="+start_date+"&end_date="+end_date,
		success:function(data){
			$('#tp_datalist').html(data);
			onCheckAll();
		}
...
function onBulkAction() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/bulkActionOrders',
...
function onPaymentOrderStatusData() {
	...
	$.ajax({
		url:base_url + "/admin/getPaymentOrderStatusData?order_master_id="+order_master_id,
		success:function(data){
...
function onExcelExport() {
	...
	var FinalPath = base_url + "/admin/orders-excel-export?status="+status+"&start_date="+start_date+"&end_date="+end_date;
...
function onCSVExport() {
	...
	var FinalPath = base_url + "/admin/orders-csv-export?status="+status+"&start_date="+start_date+"&end_date="+end_date;
