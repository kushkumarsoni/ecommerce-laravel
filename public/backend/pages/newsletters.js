...
function onPaginationDataLoad(page) {
	$.ajax({
		url:base_url + "/admin/getSubscriberTableData?page="+page,
...
function onRefreshData() {
	$.ajax({
		url:base_url + "/admin/getSubscriberTableData",
		success:function(data){
			$('#tp_datalist').html(data);
		}
	});
...
function onSearch() {
	...
	$.ajax({
		url: base_url + "/admin/getSubscriberTableData?search="+search,
		success:function(data){
			$('#tp_datalist').html(data);
		}
	});
...
function onSubscribePopupConfirmWhenAddEdit() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/SubscribePopupUpdate',
...
function onMailChimpConfirmWhenAddEdit() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/MailChimpSettingsUpdate',
...
function onSubscriberConfirmWhenAddEdit() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/saveSubscriberData',
...
function onLoadEditData() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/getSubscriberById',
		data: 'id=' + RecordId,
		success: function (response) {
...
function onConfirmDelete() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/deleteSubscriber',
		data: 'id='+RecordId,
		beforeSend: function() {
