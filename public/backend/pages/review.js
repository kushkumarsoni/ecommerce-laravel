...
function onPaginationDataLoad(page) {
	$.ajax({
		url:base_url + "/admin/getReviewRatingsTableData?page="+page,
...
function onRefreshData() {
	$.ajax({
		url:base_url + "/admin/getReviewRatingsTableData",
		success:function(data){
			$('#tp_datalist').html(data);
			onCheckAll();
		}
...
function onSearch() {
	...
	$.ajax({
		url: base_url + "/admin/getReviewRatingsTableData?search="+search,
		success:function(data){
			$('#tp_datalist').html(data);
			onCheckAll();
		}
...
function onConfirmDelete() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/deleteReviewRatings',
		data: 'id='+RecordId,
...
function onConfirmBulkAction() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/admin/bulkActionReviewRatings',
