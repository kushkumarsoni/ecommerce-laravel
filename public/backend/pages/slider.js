...
function onPaginationDataLoad(page) {
	$.ajax({
		url:base_url + "/admin/getSliderTableData?page="+page+"&slider_type="+$('#slider_type_filter').val(),
...
function onRefreshData() {
	$.ajax({
		url:base_url + "/admin/getSliderTableData?search="+$("#search").val()+"&slider_type="+$('#slider_type_filter').val(),
		success:function(data){
			$('#tp_datalist').html(data);
			onCheckAll();
		}
