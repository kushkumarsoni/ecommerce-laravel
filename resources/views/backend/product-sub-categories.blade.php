...
@section('title','Product Sub Categories Dashboard')
@push('style')
    <style>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <span>{{ __('Product Sub Categories') }}</span>
                                    </div>
                                    <div class="col-lg-6">
                            ...
                            <div id="list-panel" class="card-body">
                                ...
                                <div id="tp_datalist">
                                    @include('backend.partials.product_sub_categories_table')
                                </div>
                            </div>
                            <!--/Data grid/-->
                            <!--Data Entry Form-->
                            <div id="form-panel" class="card-body dnone">
                                <form novalidate="" data-validate="parsley" id="DataEntry_formId">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="product_category_id">{{ __('Product Category') }}<span class="red">*</span></label>
                                                <select name="product_category_id" id="product_category_id"  class="chosen-select form-control parsley-validated" data-required="true">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="name">{{ __('Sub Category Name') }}<span class="red">*</span></label>
...
@push('script-links')
    <script src="{{asset('backend/pages/product-sub-categories.js')}}"></script>
